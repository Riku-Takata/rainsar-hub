...
S1_SAMPLES_DIR = Path(os.getenv("RAINSAR_S1_SAMPLES_DIR", BASE_DIR / "s1_samples"))
S1_SAFE_DIR = BASE_DIR / "s1_safe"
HUB_DIR = BASE_DIR / "rainsar-hub"
DATA_DIR = Path(os.getenv("RAINSAR_DATA_DIR", HUB_DIR / "data"))
RESULT_DIR = Path(os.getenv("RAINSAR_RESULT_DIR", HUB_DIR / "result"))
